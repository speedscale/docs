...
For new Kubernetes installations, use the [eBPF collector](/reference/ebpf-traffic-collection). The annotations in this reference are retained for existing sidecar deployments and workloads that do not meet the eBPF requirements.
:::
...
[proxy modes](/getting-started/installation/sidecar/proxy-modes) for more information on how each mode functions.
...
[proxy modes](/getting-started/installation/sidecar/proxy-modes) for more information.
...
viewable in the Speedscale UI. See [TLS](/getting-started/installation/sidecar/tls/) for more information.
...
enables inbound TLS interception and unwrapping. See [TLS](/getting-started/installation/sidecar/tls/) for more information.
...
Do not set this unless your application uses mutual TLS. See [TLS](/getting-started/installation/sidecar/tls/) for more information.
