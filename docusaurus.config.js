    ...
    [
      "@docusaurus/plugin-client-redirects",
      {
        redirects: [
          ...
          { from: '/reference/transform-traffic/transforms/train/', to:  '/reference/transform-traffic/transforms/smart_replace/'},
          { from: '/reference/transform-traffic/transforms/train_csv/', to:  '/reference/transform-traffic/transforms/smart_replace_csv/'},
          { from: '/reference/transform-traffic/transforms/train_actual/', to:  '/reference/transform-traffic/transforms/smart_replace_recorded/'},
