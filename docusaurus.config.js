    ...
    [
      "@docusaurus/plugin-client-redirects",
      {
        redirects: [
          ...
          { from: '/configuration/tokenizers-1/http-regex/', to: '/transform/transforms/regex/' },
          ...
          { from: '/guides/replace_txn_ids/', to: '/reference/transform-traffic/common-patterns/' },
          { from: '/guides/replay/mocks/replace-txn-ids/', to: '/reference/transform-traffic/common-patterns/' },
          ...
          { from: '/guides/import-charles/', to: '/integration/import/import-charles/' },
          { from: '/guides/smart_replace', to: '/transform/smart-replace/' },
          { from: '/guides/triggers/', to: '/mocks/triggers/' },
          { from: '/reference/integrations/goreplay/', to: '/integration/import/goreplay/' },
          { from: '/reference/integrations/http_wire/', to: '/integration/import/http_wire/' },
          { from: '/guides/import-postman/', to: '/integration/import/import-postman/' },
          { from: '/guides/import-har/', to: '/integration/import/import-har/' },
          { from: '/reference/integrations/wiremock/', to: '/integration/import/wiremock/' },
          { from: '/reference/integrations/postman/', to: '/integration/export/postman/' },
          { from: '/reference/integrations/jmeter/', to: '/integration/import/jmeter/' },
          ...
          { from: '/reference/transform-traffic/transforms/csv', to: '/transform/transforms/csv/' },
          { from: '/reference/integrations/gcp/', to: '/integration/gcp/' },
          { from: '/reference/integrations/aws/', to: '/integration/aws/' },
          { from: '/reference/integrations/rancher-labs/', to: '/integration/rancher-labs/' },
          { from: '/reference/integrations/datadog/', to: '/integration/export/datadog/' },
          { from: '/reference/integrations/grafana/', to: '/integration/export/grafana/' },
          { from: '/reference/integrations/new-relic/', to: '/integration/export/new-relic/' },
          { from: '/reference/integration-with-cicd/azure-devops/', to: '/integration/cicd/' },
          { from: '/reference/integration-with-cicd/circleci/', to: '/integration/cicd/' },
          { from: '/reference/integration-with-cicd/github/', to: '/integration/cicd/' },
          { from: '/reference/integration-with-cicd/gitlab-cicd/', to: '/integration/cicd/' },
          { from: '/reference/integration-with-cicd/jenkins/', to: '/integration/cicd/' },
          ...
          { from: '/reference/tokenizers-1/http-regex/', to: '/transform/transforms/regex/' },
          ...
          { from: '/reference/transform-traffic/transforms/date/', to: '/transform/transforms/date/' },
          ...
          { from: '/reference/transform-traffic/transforms/tag_session', to: '/transform/transforms/tag_session/' },
          { from: '/reference/transform-traffic/transforms/store_sig/', to: '/transform/transforms/store_sig/' },
          { from: '/reference/transform-traffic/transforms/grpc_field/', to: '/transform/extractors/json_path/' },
          { from: '/reference/transform-traffic/transforms/json_path/', to: '/transform/extractors/json_path/' },
          { from: '/reference/transform-traffic/transforms/json_selector/', to: '/transform/transforms/json_selector/' },
          { from: '/reference/transform-traffic/transforms/jwt_resign/', to: '/transform/transforms/jwt_resign/' },
          { from: '/reference/transform-traffic/transforms/http_auth/', to: '/reference/transform-traffic/extractors/http_req_header/' },
          { from: '/reference/transform-traffic/transforms/one_of/', to: '/transform/transforms/one_of/' },
          { from: '/reference/transform-traffic/transforms/regex/', to: '/transform/transforms/regex/' },
          { from: '/reference/transform-traffic/transforms/train/', to: '/transform/transforms/smart_replace' },
          { from: '/reference/transform-traffic/transforms/smart_replace', to: '/transform/transforms/smart_replace' },
          { from: '/reference/transform-traffic/transforms/dataframe', to: 'transform/transforms/dataframe/' },
          { from: '/reference/transform-traffic/transforms/train_csv/', to: '/transform/transforms/smart_replace_csv/' },
          { from: '/reference/transform-traffic/transforms/smart_replace_csv/', to: '/transform/transforms/smart_replace_csv/' },
          { from: '/reference/transform-traffic/transforms/train_actual/', to: '/transform/transforms/smart_replace_recorded/' },
          { from: '/reference/transform-traffic/transforms/smart_replace_recorded/', to: '/transform/transforms/smart_replace_recorded/' },
