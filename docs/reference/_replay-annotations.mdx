...
| `replay.speedscale.com/generator-low-data` | Set to "true" to force the generator into a high efficiency/low data output mode. This is ideal for high volume performance tests. |
