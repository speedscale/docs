...
to requests __**FROM**__ your application, or both. Setting this to `full-replay`, both generators and responders
...
Specifies the maximum amount of time a replay is allowed to run. Ignored when replay mode is `responder-only`.
