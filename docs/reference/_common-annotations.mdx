...
| ------------------------------------ | ----------- |
| `operator.speedscale.com/ignore`     | The presence of this annotation on a workload instructs the operator to skip processing of the workload regardless of any another Speedscale annotations. Changes made to a workload manually AFTER this annotation was added won’t be reverted by the operator.|
