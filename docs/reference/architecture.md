...
To learn more about configuring DLP and Speedscale's overall approach to data security, please visit our [Data Loss Prevention Guide](/dlp/) and security [hub](/security/security_.md).