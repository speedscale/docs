...
description: "Configure your application proxy server with Speedscale by selecting your programming language to learn about specific proxy patterns and settings."
sidebar_position: 13
---
