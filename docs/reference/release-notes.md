...
## v2.5.1059: 2026-09-25

* S-13297 Use requested config in initializing replay reports
* S-13129 Retry reader tunnel during pod restart
* S-13290 Namespaced replay verbs start without Speedscale cloud
* S-13290 Namespaced replay reports get analyzed instead of timing out
* S-13290 Namespaced uninstall removes finished replay-request ConfigMaps
* S-13270 Choose replay tests with a tests filter; remove reverse services
* S-13290 Sidecar capture inject honours the install image pull policy
* S-13271 Add a Postgres load driver to the generator
* S-13291 Provision per-replay Redis when the coordinator's sigcache backend is empty
* S-13292 Give each generator RRPair exporter its own copy of the RRPair
* S-13274 Run built-in and workspace test configs on namespaced replay requests
* S-13268 Refuse explicit mocks on target-only web replays
* S-13273 Round-trip cloud replay defaults through the mock-attach flags
* S-13266 Score a replay: accuracy, mock match rate, and goals in one call
* S-13282 Apply infra replay mock attachments in mock-all mode
* S-13279 Remove em dashes from the generated MCP docs page
* S-13272 cloud replay status exits 5 when proxymock startup fails
* S-13264 Expose replay target defaults to agents
* S-13269 proxymock --test-config: accept every built-in config, and cloud config ids on cloud replay
* S-13268 Mock every recorded dependency by default on all workload replay paths
* S-13267 speedctl get reports: filter by snapshot id
* S-13259 Fix service health counts for inbound traffic
* S-13262 Keep an explicit RRPair direction when proxyLocation is absent
* S-13261 Expand reports with untagged responder rows and keep pulling the snapshot
* S-13260 Tag all responder output as outbound
* S-13256 Only gate explicit replay test configs
* S-13258 Separate content type format validation from body comparison
* S-13255 Bound snapshot traffic filter queries
* S-13252 proxymock web: analyze-with-agent prompt on the Report view
* S-13296 Clear replay config when changing scenario category
* S-13283 Choose which snapshot traffic replays as tests
* S-13259 Use exact inbound counts for homepage health
* S-13258 Show content type format assertions in reports
* S-13252 Report page: Analyze with agent prompt
* S-13234 Home: decide dashboard vs setup checklist before drawing either


## v2.5.1034: 2026-09-22

* S-13247 Protect Postgres from finished utilization collector reconnect bursts
* S-13235 fix: join analyzer pipeline before finalization
* S-13244 api-gateway: demote shutdown utilization errors
* S-13237 Bundle the install-speedscale agent skill, add mcp install --yes and mcp skills export
* S-13224 Route SSO submission activation through usr-mgmt
* S-13243 Show responder metrics in low-data reports


## v2.5.1029: 2026-09-22

* S-13186 Correlate memory BIO writes with TCP sockets
* S-13179 Report capture component provenance
* S-12979 prevent netty plaintext drops for IllegalAccessException
* S-12780 tcp flow attribution for in-memory SSL BIO types
* S-13211 speedscale: snapshot list filter values RPC, OR same-field filters
* S-13210 Transform chain events: skip/warn levels, chain runs, transform issues report
* S-13204 Remove proxymock inspect TUI
* S-13196 MCP replay tools: reach the replay features the CLI and web already have
* S-13190 DLP: record redaction once per resolved document
* S-13201 Prevent bulk capture response panic
* S-13194 Evaluate test config goals on local replays
* S-13192 Stop claiming local replay honours responder.responseDelay; keep a test config default target
* S-13193 Run every proxymock web asset JS suite in CI
* S-13190 DLP: resolve group rules in the cloud
* S-13195 MCP replay tools: one mocks default, one out directory, no silently ignored params
* S-13141 replay signals cleanup: delete what nothing reads, measure the firehose budget
* S-13191 api-gateway: stop dropping RPC role checks
* S-13183 Run a test config load stages on a local replay
* S-13176 operator: specific reasons for reconcile failures, carried to proxymock web
* S-13181 MCP test_config tool: create, edit, validate and delete workspace test configs
* S-13182 DLP: scoped group rules, resolved locally
* S-13179 Preserve nettap capture provenance
* S-13180 fix: upgrade gRPC-Go for denial-of-service advisories
* S-13187 Fix automated JWKS resigning
* S-13184 Restrict service account management to admins
* S-13174 proxymock is workspace-scoped: DLP rules, filter rules and pulled reports leave ~/.speedscale
* S-13113 Add guarded bulk eBPF capture operations
* S-13169 Make CLI credentials and report telemetry resilient to outages
* S-13177 Handle malformed UTF-8 URLs in snapshot summaries
* S-13178 Drain usr-mgmt listeners before process shutdown
* S-13160 Complete endpoint and session load plans
* S-13170 Workspace test configs and the proxymock web editor (S-13170, S-13171)
* S-13173 Blueprints assemble only from the workspace, never from ~/.speedscale
* S-13172 Normalize proxymock Infra direction
* S-13227 Dashboard Home: live control-room overview
* S-13211 dashboard: filter Traffic Snapshots by service and tag
* S-13218 dashboard: scan latest published release image
* S-13213 dashboard: step through recommendations and highlight the field each targets
* S-13210 RRPair Log tab chain runs + report Transform Issues tab
* S-13205 Suggest proxymock web instead of proxymock inspect
* S-13190 dashboard: edit DLP group rules
* S-13182 dashboard: regenerate the DLP client for group rules
* S-13141 timeline: severity column, rebuilding note, drop the dead replay-event row
* S-13176 replay progress: place the operator's reconcile failure reasons
* S-13185 Open workload drawer from Infrastructure map
* S-13184 Clarify API key config downloads
* S-13113 Add namespace and label bulk capture controls
* S-13175 Show workload progress and render namespaces as they load


## v2.5.1008: 2026-09-16

* S-13105 add support for v1 cgroups
* S-13022 capture support for rustls
* S-13123 Restore Go capture after re-enable
* S-13164 proxymock CLI/MCP parity: cloud-free cluster replay start + cloud replay verb
* S-12242 Cloud-free in-cluster replay: stage snapshot in forwarder, keep report in-cluster
* S-13163 Resolve remote logs by workload kind
* S-13143 telemetry: give replay events their id when they are built
* S-13144 operator: make every replay resource idempotent, not just ConfigMaps
* S-13129 Native GCS discovery and dedicated cluster reader
* S-13133 Add Redis responder support
* S-13156 Add Locust traffic export
* S-12118 Stream bucket imports with progress and cancellation
* S-13153 Prevent mock-miss explanation from panicking on missing signatures
* S-13154 Fix trace waterfall requests rejected by the list page limit
* S-13072 Bound repeated responder misses
* S-13146 Handle summaries for empty snapshots
* S-13147 Return NotFound for absent remote log targets
* S-13148 Accept the Entra tenant ID as the SSO submission domain
* S-13149 Skip zero-only indexer metrics and fix CloudWatch batching
* Endpoint and session load plans for generator and proxymock (S-13073)
* S-13143 operator: close the lifecycle gaps a cluster run found
* S-13144 operator: make replay ConfigMap provisioning idempotent
* S-12118 Suppress skipped-checksum warnings during BYOC imports
* S-13134 fix: preserve MySQL midstream queries and result rows
* S-13132 fix: preserve direct MongoDB replica set identity
* S-13130 fix: tolerate snapshots without MySQL handshake
* S-13122 fix: coordinate Kafka consumer groups
* S-13121 fix: match Kafka v16 Fetch by topic identity
* S-13142 Upgrade runtime Perl to fix critical vulnerabilities
* S-13131 fix: return valid prepared transaction status
* S-13128 Make bucket import failures concise and actionable
* S-13141 lib: put log severity back on report timeline entries
* S-13126 goproxy: read Kafka BYTES length prefixes as int32
* S-13137 generator: report readiness, stages and load progress as lifecycle steps
* S-13136 operator: emit replay lifecycle events at every transition
* S-13135 lib: ReplayLifecycleEvent on TestReport
* S-13125 remove dead coordinator.asserters left over from deleted assertion streamer
* S-12836 Detect unavailable forwarders and bound stale connections
* S-12835 Emit native OTLP trace context and service resources
* S-13114 Fix put filter panic when no filename is given
* S-13163 Preserve workload kinds in log requests
* Fix workload drawer grid sizing across tab switches
* S-13146 Refresh empty snapshots and skip stale recommendations
* S-13148 Accept the Entra tenant ID in the SSO settings form
* S-13140 dashboard: read replay lifecycle events, keep the log fallback
* S-13117 dashboard: Replay Progress panel on the report Overview tab


## v2.5.978: 2026-09-11

* S-13108 api-gateway: absorb utilization streams for finished reports instead of rejecting them
* S-13110 Count malformed RRPairs inside OTLP import batches
* S-13112 Fix prompt report status percentages
* S-13111 Preserve large NDJSON records during object imports
* S-13109 Retry transient object import failures
* S-12334 Add native GCS traffic imports across CLI, MCP and web
* S-13099 Discover BYOC storage across collector namespaces
* S-13096 Validate S3 import prefixes and endpoints
* S-13104 match Kafka Fetch responses across consumer rebalances
* S-13097 Avoid empty output directories on unsuccessful S3 imports
* S-13095 api-gateway: return Canceled when the caller hangs up during the AddFilterRule existence check
* S-13053 api-gateway: list snapshot patch entries and restore deleted RRPairs
* S-13053 Snapshot RRPair list: restore deleted RRPairs
* S-13057 Populate active SSO settings in the dashboard
* S-13064 Add service map logos for the newly detected SaaS APIs
* S-13063 Show technology icons on the Infrastructure service map


## v2.5.967: 2026-09-10

* S-13057 Return active SSO application settings without secrets
* S-12800 Support custom Redis and Java images
* S-13053 analyzer: merged RRPairs bypass inherited patch deletions
* S-13067 proxymock MCP installer: detect and configure Amazon Kiro
* S-13068 proxymock MCP: Streamable HTTP transport, --sse deprecated
* S-13066 api-gateway: harden the utilization writer and close streams for finished reports
* S-13064 Detect Stripe, Plaid, SendGrid, Moodys and fourteen more SaaS APIs from wire signals
* S-12970 api-gateway: log migration backend pid, add concurrent-migrator test
* S-13053 Snapshot RRPair list: restore deleted RRPairs
* S-13057 Populate active SSO settings in the dashboard
* S-13064 Add service map logos for the newly detected SaaS APIs
* S-13063 Show technology icons on the Infrastructure service map
...
* S-13051 meter cluster capacity from the forwarder heartbeat
* S-13052 collect and apply dashboard SSO settings
* S-13051 usr-mgmt: add cluster_capacity tables for forwarder capacity samples
* S-13050 proxymock web labels for new DLP patterns
* S-13047 track tenant license and SSO setup entitlement
* S-13048 update govulncheck for Go 1.27
* S-13043 score DLP recommendations on field-level evidence; add nine sensitive patterns; recognize GTIN/IMEI/epoch and per-issuer card lengths
* S-13045 Serialize binary transform diffs as hex dumps
* S-12960 bound utilization metric streams
* S-13010 gate credit card detection on issuer prefix; wildcard the varying JSON array index
* S-13051 show cluster capacity on the Usage tab
* S-13056 Separate SSO provider setup and verify instructions
* S-13052 collect SSO settings with complete Microsoft and Okta guides
* S-13055 dashboard: remove shadowed duplicate replayTraffic.steps block
* S-13047 show SSO setup for entitled paying tenants
* S-13043 dashboard labels for new DLP patterns
* S-13044 Patch dashboard libuuid vulnerabilities


## v2.5.950: 2026-09-04

* S-13005 additional ELF debugging information for captured processes
* S-13007 gracefully handle misconfigured non-java processes
* S-12890 correct goid offsets for 1.25+
* S-12890 remove debug logging
* S-12890 account for SP shuffling between go uprobe/uretprobe
* S-12505 nettap to send logs via OTLP to the forwarder
* S-12865 fix unmarshal error in ebpf map diagnostics
* S-12952 expose tenant SSO setup metadata
* S-13024 prevent service usage part storms
* S-13025 preserve Kafka all-topic metadata for consumers
* S-12955 stop collectors after terminal cleanup-none replays
* S-12954 Retry transient AWS credential fetch failures
* S-12973 bound forwarder OTLP log batching
* S-12978 operator: propagate global annotations to nettap
* S-13014 Lock snapshot: read-only until unlocked by the locking user or an admin
* S-12336 webui: sandbox HOME in consolidation test to isolate legacy blueprint fallback
* S-12956 proxymock web: run-backed filter dropdowns and strict transform filters
* S-13019 centralize URL path-segment id classification in lib/urltemplate
* S-12997 upgrade to go1.27.1
* S-13013 increase retry attempts for transient failures
* S-12998 address CVE-2026-56854
* S-12999 limit review bot to MRs
* S-12864 make snapshot size error a warning with suggestion
* S-13000 inspector,api-gateway: report node placement per workload
* S-12999 enable bot review
* S-12897 speedmgmt: the chart TLS secret is a signing CA with an app trust bundle
* S-12897 forwarder,inspector: scope discovery to the namespace in namespaced mode
* S-12897 lib: crash-proof the telemetry reporter and panic logging
* S-12897 speedctl: sidecar image honors the deployed install's registry and tag
* S-12897 operator: uninstall sweeps proxymock-staged snapshot ConfigMaps
* S-12961 responder: start empty when the snapshot has no mockable dependencies
* S-12963 generator: keep the log tap alive through main's Fatal
* S-12919 operator: static runtime RBAC and a self-check true to the chart
* S-12925 lib: normalize digests against API-server defaulting, default TLS dir
* S-12907 speedmgmt: embed and emit the speedscale-namespaced chart
* S-12936 speedctl: route web and MCP capture/replay through namespaced surfaces
* S-12953 lib: Configure applies overrides on nil annotations, builder guards cert dir
* S-12933 operator: cleanup scan must not match the chart's own control plane
* S-12984 analyzer: identify a transform recommendation by its fix
* S-12933 operator: add namespaced-cleanup pre-delete command
* S-12932 lib: layered inventories and replay-over-capture restore
* S-12919 operator: align coordinator settings with the chart config keys
* S 12505
* S-12925 speedctl: sidecar capture inject/status/uninject with inventory
* S-12928 operator: add namespaced replay coordinator over replayrequest
* S-12930 lib: add static replay-runtime Role builders
* S-12910 speedctl: add Speedscale namespace selection and validation
* S-12918 operator: add builder-parity harness with reviewed exemptions
* S-12922 operator: extract I/O-free mutation into lib/workloadmutation
* S-12923 lib: add named-secret variants for sidecar-path builders
* S-12913 operator: add helmgen spike artifacts and recommendation
* S-12929 operator: source kube API address without default-namespace reads
* S-12921 lib: add workloadmutation contract types and design
* S-12920 operator: add golden-file corpus for webhook mutations
* S-12927 lib: add replayrequest ConfigMap store and state machine
* S-12952 add account-specific SSO setup guide
* S-13026 remove unused AdvanceTab component
* S-13014 dashboard: lock and unlock snapshots
* S-12987 feat: add a decline button to the consent page
* S-12986 patch libexpat in dashboard image
* S-12947 Warn when snapshot transforms match no traffic
* S-13009 fix: surface the Auth0 denial reason on the unauthorized page
* S-13021 include sduncanbot MR review
* S-13020 ensure diagnostics run to completion instead of erroring
* S-13016 dashboard: carry the workbench section header onto the report overview
* S-13001 dashboard: show cluster and nodes in the workload drawer
* S-12976 S-12804 S-12977 S-12983 dashboard: snapshot detail redesign
* S-12972 fill the drawer with the GraphQL query view
* S-12825 Scoped chaos rule editor in the test config


## v2.5.915: 2026-08-31

* S-12885 fix layered TLS capture for OkHttp on JDK 17
* S-12684 keep agent diagnostics state in one classloader copy and drop the...
* S-12829 add Java Agent inbound coverage to compatibility matrix
* S-12844 fix Java Socket capture on newer JDKs
* S-12867 prefer downward api env vars when available
* S-12822 Run nettap image as non-root
* S-12849 add java agent test support matrix
* S-12684 full diagnostics tarball generation for nettap
* S-12803 java-agent jar to report version number consistent with nettap version
* S-12892 Redact secrets from goproxy diagnostics
* S-12888 Fix sidecar health join, log scanner limits, and old-inspector command gates
* S-12891 ensure reconnect to nettap data socket
* S-12847 goproxy api for capturing diagnostics
* S-12856 graphql_delete transform: remove selections and arguments by semantic path
* S-12857 match GraphQL requests that differ only in argument order
* S-12881 Remove committed gcrpull2 GCR credential
* S-12883 locate a GraphQL request by its operation in the responder
* S-12880 keep a persisted-query request intact through capture and replay
* S-12855 preview what a GraphQL value becomes
* S-12851 allow remote diagnostics collection from nettap installations
* S-12855 enumerate the editable values of a GraphQL request
* S-12876 Reduce cron execution S3 list requests
* S-12854 add graphql transform with semantic path addressing
* S-12867 add downward api env vars for java-agent consumption
* S-12863 Move Chaos Rules to Overrides, out of Config
* S-12822 Run nettap daemonset as non-root
* S-12851 allow nettap diagnostics capture via UI or CLI
* S-12824 honor connection start information to prevent unncessary stream sync
* S-12743 Bound a chaos rule to a time window
* S-12832 fix: upgrade gopacket for GO-2026-6121 and GO-2026-6122
* S-12840 lib: order filter picker values by frequency
* S-12722 Scope preview: separate "matches nothing" from "never gets to fire"
* S-12730 Say so when a chaos rule can never fire
* S-12722 Promote the Filters-modal borrow to a real API, and stop dropping six predicates
* S-12809 pre-emption safeguards and right-sized ephemeral storage
* S-12771 Stop rounding large integers on every JSON body rewrite
* S-12802 tag fetch and clone depth efficiency
* S-12813 cron: SSRF guard on notify webhooks
* S-12794 Add chaos to RRPairMinified and carry it to the grid
* S-12808 analyzer: prevent zip-slip in archive import
* S-12794 Add the chaos column to rrpairs_meta
* S-12718 Aggregate what chaos did to a run, shared by both surfaces
* S-12721 Apply payload chaos, typed, and prove it reaches the wire gzipped
* S-12769 Preserve a JSON field's type when re-inserting a value
* S-12763 Scan the responder's responses for the chaos marker, not the generator's pairs
* S-12791 raise snapshot RRPair limit to 1 million
* S-12768 workload sidebar: open at 75% width and show the workload's Kubernetes events
* S-12767 regenerate gateway.client.ts to match gateway.ts; add client/descriptor alignment test


## v2.5.878: 2026-08-20

* S-12777 accept session-cookie credential in getAPIKey
* S-12772 upload cli binaries to gcs
* S-12776 Scope chaos against the request, not the stored reaction
* S-12761 fix claude code warning for repo
* S-12764 use artifact registry as npm mirror
* S-12763 Assert that configured chaos was actually applied
* S-12723 Exclude chaos-affected pairs from drift and match-rate analysis
* S-12742 Configure operator settings remotely
* S-12723 One chaos-affected predicate for every reader
* S-12740 Surface capture errors and reload storage setting
* S-12766 upgrade to pnpm 11 and move pnpm config to pnpm-workspace.yaml
* S-12742 Render registered operator settings
* S-12740 Show inspector capture errors


## v2.5.868: 2026-08-17

* S-12735 ensure port filtering honored for java-agent captures
* S-12702 sequence numbering parity for java-agent
* S-12693 include per-payload chunk numbering
* S-12669 include conn start timestamp in data chunks if possible
* S-12732 Restore scratch transformer Lambda image
* S-12720 Chaos v2: reach chaos rules from local proxymock
* S-12734 Parenthesize the --query-string help example
* S-12669 prevent unbounded memory growth from invalid dissector reads
* S-12719 Chaos v2: chaos rule engine in the responder
* S-12716 Chaos v2: show chaos in proxymock-web
* S-12726 additional use of mirrored images
* S-12726 use artifact registry mirrored images for container builds
* S-12715 Chaos v2: persist the chaos marker and add the ChaosRule schema
* S-12697 Chat evals: continue frontend tool rounds
* S-12700 preserve symbol tables in release builds
* S-12703 avoid pipefail in release tag selection
* S-12703 fix dashboard release versioning
* S-12726 use internal docker image mirror
* S-12682 fix dashboard nightly security scan
* S-12656 shrink the production dependency graph
* S-12648 phase 4: build-time kill switch for the cookie session
* S-12657 add a baseline security header set to template.conf
* S-12655 scrub customer data out of Datadog RUM
* S-12652 auth and transport hardening
* S-12648 phase 3: take identity from the gateway, not Auth0
* S-12647 make the Trivy security gate actually gate


## v2.5.857: 2026-08-11

* S-12637 move to new CI platform
* S-12670 configure operator pods to bind on 9443 instead of 443
* S-12648 phase 1a: shared bearer-first credential extractor
* S-12623 bug fix: repaint the workload drawer when dependencies arrive
* S-12661 bug fix: give analyzer tests a 300s timeout
* S-12641 Default the Requests grid to newest-first
* S-12659 usr-mgmt: remove unreachable query-param and cookie auth fallbacks
* S-12660 improve layout rendering for proxymock web topology
* S-12629 Resolve ClusterIP topology destinations to workloads
* S-12643 change base application images to debian trixie
* S-12642 fix: apply exporter filters per exporter, not to the whole fan-out
* S-12636 Keep the Automations button reachable on a narrow viewport
* S-12648 phase 2b: hold the session in an httpOnly cookie
* S-12651 validate URL scheme on backend-supplied hrefs
* S-12646 patch browser-shipped dependencies with known CVEs
* S-12650 chat: require confirmation for server-mutating tools
* S-12649 mermaid: render with securityLevel 'strict'
* S-12648 phase 2a: route access-token reads through one accessor
* S-12648 phase 0: serve the API same-origin in development
* S-12637 move to new CI platform


## v2.5.846: 2026-08-06

* S-12605 modify k8s informers to support namespace limited rbac
* S-12634 fix whitespace handling for ca certs file
* S-12633 fix: honor settings secret redaction
* S-12628 fix(operator): hand workload back to concurrent replay on cleanup
* S-12630 fix broken workloads on helm install
* S-12617 replace test usage of docker compose
* S-12622 restore nightly security scans
* S-12611 chat evals: support Sonnet 5 judge
* S-12620 feature: operator config registry; move Observability reads to the Kube API
* S-12618 fix(operator): upload generator ConfigMap to report artifacts
* S-12619 fix(analyzer): wait out Firehose delivery on a failed replay
* S-12323 fix lambda publish
* S-12323 fix project registry settings and others
* S-12323 CI pipeline overhaul
* S-12615 sanity check rrpair command and location fields for bad data
* S-12610 fix: scope replay wait lookups
* S-12605 update helm and operator to account for nettap config changes
* S-12578 feat: semantic response comparators for replay and Compare
* S-12605 limit nettap configmap access to its own namespace
* S-12606 fix: route Luna through OpenAI Mantle path
* S-12576 fix: don't send empty UUID filter predicate to service summary


## v2.5.828: 2026-07-31

* S-12580 allow setting ephemeral storage resources for gke autopilot
* S-12596 fix: preserve RRPair when JWT claim insertion is skipped
* S-12595 feat: add Bedrock Mantle Responses provider
* S-12593 api-gateway: stop paging on stream teardown, fix reconnect eviction
* S-12571 Scope proxymock local snapshots per workspace
* S-12524 feat: attribute load-run CPU between the app and the test harness
* S-12566 Report every blueprint that applies, and whether it fired
* S-12567 feat: store and retain snapshots in a customer bucket (CLI + MCP)
* S-12575 fix: stop the heartbeat-swallow goroutine spinning a core
* S-12577 fix: drop top-level oneOf from search_rrpairs tool schema
* S-12576 fix: don't 500 on empty UUID rrpair filter
* S-12548 stop accepting data chunks without readers and set hwm per flow
* S-12569 feat: read filter rule from in-cluster ConfigMap; sever cloud download
* S-12539 Read DLP rule from in-cluster ConfigMap; operator-config panel
* S-12546 fix: upgrade gRPC for GO-2026-6061
* S-12547 speedscale: mask secrets in settings.Print log dumps
* S-12438 Show eBPF capture health in the dashboard
* S-12476 feature: sampled traffic filter in filter dialog
* Point staging dashboard at prod auth


## v2.5.814: 2026-07-28

* S-12535 extended capture support for java agent (netty)
* S-10546 vimto kernel version compatibility tests
* S-12507 update internal documentation
* S-12446 compatibility: 5.15 kernels for x86_64
* S-12542 proxymock replay: gate on the change, not the failing pair
* S-12541 fix --require-blueprint chain-completion detection
* S-12545 fix: split nettap RBAC by resource scope
* S-12537 fix: apply proxymock connection faults on HTTP/2
* S-12536 proxymock replay: score response bodies in the replay verdict
* S-12533 fix: diagnose semantic-equal JSON drift
* S-12525 proxymock: improve blueprint, wrapper, and MCP DX
* S-12532 fix: make snapshot registration best-effort before analysis
* S-12531 fix: bound cluster stats inventory
* S-12529 proxymock web: disable unreachable traffic sources in the Get traffic picker
* S-12523 proxymock: validate RRPairs against OpenAPI specs
* S-12522 proxymock mock: native fault injection
* S-12517 perf: reduce mock server hot-path overhead
* S-12528 DLP and Filter rule editors for proxymock web
* S-12521 feat: add native replay verdicts
* S-12272 fix: responder readiness gate fails open under Istio native sidecars
* S-12499 fix: prevent collector failures from blocking mocks
* S-12509 fix AI chat traffic search tool loops
* S-12511 fix: reject empty mock tuning baselines
* S-12510 fix: preserve analyzer report serialization
* S-11657 tenant lifecycle: signup recovery + domain unregister tooling (usr-mgmt, api, speedmgmt)
* S-12500 fix: remove stale Java truststore options
* S-12518 fix: proxymock Postman URL imports
* S-12515 feat: expose proxymock load-test mode
* S-12516 Avoid crypto UUIDs for transform events
* S-12473 fix: bound fakeout metadata retries
* S-12470 fix: InitReplayV2 panics when snapshot action file is missing
* S-12487 fix: bound gRPC frame decoding
* S-12496 bug fix: wire snapshot log reporter into a.logger so snapshot-log.jsonl is written
* S-12489 remediate GO-2026-5970
* S-12488 proxymock cluster replay orchestration and topology/logs/events (CLI + MCP)
* S-12485 feature: representative time-window fit on local snapshot push (proxymock-web + MCP)
* S-12483 feature: sample traffic when pushing a snapshot (proxymock-web + MCP)
* S-12438 Report eBPF collector health
* S-12482 proxymock cluster capture verbs and grouped cluster MCP tool


## v2.5.789: 2026-07-21

* S-12481 Remove EndpointSlice mock readiness gate
* S-12476 feature: session-atomic sampling filter predicate
* S-12472 proxymock CLI: match-rate and recommendations tuning verbs
* S-12457 performance: fix analyzer calcDLPLocations quadratics; report matched rrpair count
* S-12471 feature: Active Replays observability tab + cancel
* S-12433 fix: render nettap namespace role bindings
* S-12469 feature: one-hop service map in Topology workload drawer
* S-12456 fix: synthesize Kafka session responses
* S-12442 proxymock-web: session-location auto-focus + Replace-credentials wizard in readiness
* S-12468 feat: wait for replay mock readiness
* S-12458 Remove deprecated proxymock MCP aliases, group recommendations and snapshot tools
* S-12392 fix snapshot append dialog state reset


## v2.5.778: 2026-07-17

* S-12455 performance: memoize DLP DiscoverPattern
* S-12453 performance: cache compiled filter regexes and unblock snapshot analysis
* S-12448 remove obsolete staging transformer build
* S-12441 Group proxymock MCP mock-tuning tools into a mocks tool
* S-12443 suppress expected RRPair NoSuchKey log
* S-12389 fix: make header EQUAL exact
* S-12437 mcp: de-flake search_local truncation test
* S-12425 Unique session replay: readiness, uniquification, verification, snapshot export
* S-12429 fix: preserve mid-chunk stream boundaries
* S-12407 Mock match-rate pattern discovery (time-anchored, GraphQL, provenance, UI)
* S-12392 fix snapshot append dialog state reset


## v2.5.768: 2026-07-13

* S-12381 reduce noise level for dns observation logs
* S-12396 declutter proxymock top-level command tree
* S-12423 ensure scoped helm template vars are anchored
* S-12393 proxymock files edit/delete: CLI commands for RRPair body edit and delete
* S-12395 don't replay HTTP/1.1 traffic mislabeled tech=gRPC as gRPC
* S-12405 speedctl/mcp: improve_mock_match_rate prompt + installable skill body
* S-12403 speedctl/mcp: pull_report tool (report + source snapshot into workspace)
* S-12383 fallback to report rrpairs after s3 expiration
* S-12402 speedctl/mcp: analyze_mock_matches + accept_mock_recommendation tools
* S-12401 speedctl/webui: extract headless MocksTuner from the mocks handlers
* S-12399 speedctl/webui: reframe Mocks as filter-scoped recommendations you accept
* S-12390 fix Kafka response encoding
* S-12394 speedmgmt: audit and migrate legacy header filters
* S-12387 speedctl: generate MCP tool + inbound/outbound directions (OpenAPI -> RRPairs)
* S-12391 Protect api-gateway from inspector disconnect panic
* S-12385 proxymock MCP: add grouped dlp tool (test|apply)
* S-12363 prefer http header for hostname determination rather than dns discovery
* S-12386 fix snapshot heartbeat recovery
* S-12384 bug fix: skip binary signature values in transform generation
* S-12376 disable RDB snapshots for replay redis cache
* S-12378 proxymock filter/transform test/apply — local config authoring
* S-12380 speedctl/webui: Mocks report vs projected match rate
* S-12377 nil-check in api-gateway to avoid potential panic
* feat: proxymock MCP pull_byoc_bucket tool for BYOC bucket pull
* S-12375 fix: bump vuln-affected Go deps


## v2.5.744: 2026-07-08

* S-12274 prevent ebpf double captures when java agent present
* feat: proxymock MCP import_traffic and export_traffic tools
* S-12370 feat: proxymock import har/wiremock/goreplay/http-wire convert to local RRPairs
* S-12369 proxymock-web: grouped AND/OR filters for the Requests grid
* S-12350 proxymock: volatile-field learning + stable-field response diff
* S-12360 sigcache: remove dead legacy rankMapSimilarity scorer
* S-12347 speedctl: generate MCP tools/prompts reference (proxymock mcp docs)
* S-12364 proxymock-web: flag drift fields with a pending recommended fix in Similar tab
* S-12367 speedctl: add list_recommendations, apply_recommendation, push_snapshot, list_cloud_snapshots MCP tools
* S-12325 indexer: pause queue consumption while ClickHouse is unavailable
* S-12368 speedctl: add edit_rrpair, delete_rrpairs, detect_drift, send_one MCP tools
* S-12366 proxymock-web: understand JSON embedded in JSON strings in Similar sigs and transforms
* S-12357 proxymock dlp test/apply — local DLP rule authoring against RRPair files
* S-12365 proxymock-web: auto-open Similar tab for no-match recs during iteration
* S-12275 Reduce snapshot recommendation memory
* S-12362 proxymock-web: add field-transform shortcut to Similar body diff modal
* S-12354 api-gateway: don't page on-call for stuck reports that get cancelled
* S-12356 feat: proxymock import postman converts collections to local RRPairs
* S-12359 Group traffic recommendation details
* S-12341 proxymock-web: SQL workload comparison between runs
* S-12358 proxymock-web: scrub instance from Similar diff, add JSON body diff popout
* S-12347 Reduce static asset recommendation noise
* S-12348 speedctl: add load test parameters to MCP replay_traffic tool
* S-12340 proxymock-web: extract SQL statements automation + full-screen report view
* S-12332 S-12339 speedctl: add search_local_traffic MCP tool fix mcp tests
* S-12338 proxymock-web: show non-HTTP protocol bodies in RRPair detail and search
* S-12330 report directory format: CLI, MCP, and web
* S-12318 Make speedmgmt ping read latest objects
* S-12274 allow java-agent tag specification
* S-12320 Fix Kafka InitProducerId replay response
* S-12322 api-gateway: don't treat grpc.ErrServerStopped as fatal during shutdown
* S-12273 fix: preserve eBPF flag on Java agent refresh
* S-12259 feat: Trace waterfall lens in the traffic viewer
* S-12263 feat: offer contains for HTTP header filters
* S-11994 hide empty play demo surfaces


## v2.5.715: 2026-07-02

* S-11261 handle config changes for otlp
* S-12073 fix ingress/egress identification for dual-stack listen addrs
* S-12314 fix: operator startup without Argo Rollouts
* S-12271 fix: remove extra SASL host change
* S-12315 feature: proxymock-web responder match-rate analysis for pulled cloud reports
* S-12072 rrpair-to-otel backwards compatible perf improvements
* S-12271 fix: Mongo SASL blueprint secrets
* S-11994 improve fakeout demo reports
* S-12286 feat: workload CPU/memory utilization bars in Topology drawer
* S-12277 fix: support rollouts in nettap capture
* S-12270 feat: filter Requests by trace-id from traceparent header
* S-11994 sync fakeout artifact metadata
* S-12258 feat: RetrieveTrace gateway RPC
* S-12263 feat: honor contains operator for HTTP header filters
* S-12257 refactor: extract trace waterfall algorithm into shared lib/trace
* S-11994 add complete banking fakeout demo data
* S-12273 fix: preserve eBPF flag on Java agent refresh
* S-12259 feat: Trace waterfall lens in the traffic viewer
* S-12263 feat: offer contains for HTTP header filters
* S-11994 hide empty play demo surfaces
...
* S-12252 bug fix: indexer demote in-flight errors to Warn during graceful shutdown
* S-1224 transform diff in proxymock web
* S-11994 refresh play fakeout banking data
* S-12068 fix: retry TrafficReplay inventory readiness
* S-12250 Restore Signature tab in snapshot view; gate on direction === OUT


## v2.5.697: 2026-06-26

* S-12232 remediate nightly govulncheck findings
* S-12228 feat: add responder sqlite sigcache backend
* S-12093 fix: Kafka replay record production
* S-12188 Eliminate 100% CPU on very large RRPair directories
* S-12224 speedscale: fix date transform auto-layout cache poisoning
* S-12196 feature: trace waterfall view in proxymock-web
* S-12223 Add agent job timestamps
* S-10679 Append recommendations to staged config


## v2.5.691: 2026-06-25

* S-11708 disallow data chunk drops for slow reads
* S-11843 track iovec pointers in tcp_recvmsg fentry
* S-12193 set nettap pod priorityClassName
* S-12192 fix: retry responder Redis cache population
* S-12173 Honor snapshot timeout in api-gateway
* S-12182 improve: update proxymock web dark palette
* S-12180 remove noisy forwarder log
* S-12130 Distinguish replay provisioning delays
* S-12152 feat(session): auth→tag_session blueprint recommendation
* S-12136 feat(session): journey / funnel mining + Sankey flow view
* S-11932 Map staging2.speedscale.com to prod Auth0


## v2.5.683: 2026-06-22

* S-11752 add usage based cache expiration to dns lookups
* S-12132 reduce overall cpu usage: proper node scoping and cgroup enhancements
* S-11943 simplify overall surface area for connection status reporting
* S-11843 handle nr_segs > 1 for iovec iter types
* S-12058 S-12062 nettap: add trivy+govulncheck scans, remove orphaned demo app
* S-12135 feat(session): Sessions report view + journey drill-in
* S-12113 proxymock web: read BYOC bucket from collector config
* S-12134 feat(session): session index + journey model foundation
* S-11943 update otel data consumption in forwarder
* S-12131 proxymock web: Identify PII category views + multi-instance port fallback
* S-12113 feat: add web BYOC S3 import
* S-12121 harden .builder against transient registry/runner flakes
* S-12124 speedctl telemetry: stable persisted device id as PostHog distinct_id
* S-11752 use upstream hostname when available
* S-12111 proxymock: return email from anon verify and forward it in CLI init
* S-12107 Fix Kafka SASL replay bootstrap
* S-10581 Remove retired HubSpot + Notion from usr-mgmt README
* S-12106 add transform changes view to RRPair details
* S-12097 proxymock web: serve real favicon
* S-12095 fix(webui): consolidate nested blueprint/dataframe artifacts
* S-12090 proxymock MCP: run the server with no command timeout
...
* S-12058 S-12056 govulncheck scan matrix + remove trafficlab-java from goproxy
...
* S-10551 analyzer: improve sqlite DB handling
...
* S-10339 S-10396 S-10408 fix host related details all around
