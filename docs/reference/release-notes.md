...
* S-11637S-11751 feat: add speedmgmt tenant node-counts + inspector RAM reporting
...
* SPD-11394 Upload TrafficReplay CR manifest before kube.CreateReplay
* SPD-11256 Add latency regression, volume mismatch, and error rate deviation TrafficRecommendations
...
* S-108763 add proxymock report interface
...
* Revert "Squashed branch 'SPD-11519/nettap-sys-kill' via merge request speedscale/speedscale!6189"
* SPD-10702 Detect WebSocket traffic in tech detector
* SPD-11577 usage stats: track LLM tokens
* S-10674 partial work for mid-stream http2 boundary sync
* SPD-11533 Report forwarder limit with tenant info
* S-10676 mid-stream sync/capture for ebpf kafka capture
* SPD-11535 Add multiple exporters to responder
* SPD-11618 mid-stream sync/capture for ebpf mongodb capture
* S-10694 instructions for agents working with clickhouse migrations
* SPD-10689 add trafficlab project to replace goproxy test envs
* SPD-11620 mid-stream sync/capture for ebpf redis capture
* SPD-11535 Make generator use multiple rrpair exporters
* SPD-11600 mid-stream ebpf capture for postgres
* SPD-11597 update speedctl config.yaml to config.json
* SPD-11577 chat: ensure table field migration works by deleting the old table
* SPD-11441 postgres mid-stream protocol capture
* SPD-11577 chat: migrate table columns to use existing standards
* SPD-11598 proxymock: fix inspection for websocket traffic
* SPD-11535 Set up otel exporters in forwarder
* SPD-10645 chat: fix erroring LLM request
* SPD-11101 update websocket support
* SPD-11544 chat tuning
* SPD-11535 Cleanup: Remove forwarder settings as a global singleton
* SPD-11108 Add custom TLS Java tool options annotation
* SPD-11585 more helpful linter error: don't exit in subshell during linting
* SPD-11580 Delete unused and deprecated internal rpcs
* SPD-11516 Delete deprecated rrpair fields
* SPD-11433 investigate link goes to blank page
* SPD-11573 Only upload workload yaml once
* SPD-11441 mid-stream protocol identification for mysql
* SPD-11544 chat: add fetch_docs_url tool for live docs lookup
* SPD-11535 Add exporter interface and otel exporter
* SPD-11551 logging: standardize controller-runtime logger setup
* SPD-11422 Support combined eBPF and Java agent capture
* SPD-11544 chat: fix tool loop exhaustion and missing log sources
* SPD-11350 chat: persist session details in clickhouse
* SPD-11544 chat: add RRPair counts to AI summary
* SPD-11350 chat: track context used
* SPD-11494 Add user_frustrated tool to chat LLM toolset


## v2.5.395: 2026-04-01

* SPD-11543 fix service account retrieve permissions
* SPD-11538 lint: limit the number of concurrent lint processes
* SPD-11492 Add error logs to chat package for on-call visibility
* SPD-11530 lint: prevent breaking changes to proto files
* SPD-11532 Add forwarder limit related endpoints and RPCs
* SPD-11532 Add table to track forwarder limits per tenant
* SPD-11487 Prevent data race in test
* SPD-11528 fix autogen transforms: URL segment guard and body chain key collision
* SPD-11487 handle HTTP / HTTPS mixed services gracefully
* SPD-11519 nettap: add SYS_KILL capability to capture container
* SPD-11502 Move generative ai features to bedrock
* SPD-11396 add include/exclude to speedctl infra replay
* SPD-11511 Allow Developer and Maintainer roles to retrieve all artifacts
* SPD-11508 de-tune clickhouse connection alerts when they recover gracefully


## v2.5.381: 2026-03-26

* SPD-11215 RBAC: implement admin/maintainer/developer roles (backend)
* SPD-11490 Add bedrock chat provider
* SPD-11485 support mysql_native_password for mariadb mocks
* SPD-11474 invalid proto error: fix latency table format on upload
* SPD-11483 Pass client context as user-role message instead of system prompt
* SPD-11480 fix: add nil check for pem.Decode to prevent panic on malformed cert data (SPD-11480)
* SPD-11482 remove limit on number of bytes that can be used for detection
* SPD-11469 add read_log_content chat tool for searching log files
* SPD-11473 fix(gatling): pass CLI flags through, derive class name from output filename,...
* SPD-11458 detector: add Perplexity AI as supported LLM provider
* SPD-11452: RBAC: Add role column DB migration (user_role enum, migrate is_tenant_admin)
* SPD-11470 mark tls rrpairs correctly when obtained via ebpf


## v2.5.369: 2026-03-24

* SPD-11472 Run nettap as root
* SPD-11420 Add permission and make sys paths configurable
* SPD-11447 Handle invalid utf encodings in indexing
* SPD-11411 fix MongoDB SASL authentication during replay
* SPD-11451 Remove responder triggers feature
* SPD-10519: fix findTenant() silently swallowing lookup errors
* SPD-11453 process server-initiated protocols correctly
* SPD-11432 Do not inject sidecar on replays
* SPD-11446 Remove dnat mode and unused X-Speedscale-Message header
* SPD-11420 Reduce nettap permissions
* SPD-11443: Fix primary_detected_tech in RRPairs service summary merge
* SPD-11429 detector: add LLM provider detection for OpenAI, Anthropic, Gemini, OpenRouter, Grok
* SPD-11440 deps: upgrade google.golang.org/grpc v1.79.2 -> v1.79.3 (CVE fix)
* SPD-11415 Fix trivy build
* SPD-11419 dependency upgrades: including refactoring


## v2.5.354: 2026-03-18

* SPD-11416 Add settings to bring your own cert during helm install
* SPD-11430 linter: ensure test file names match
* SPD-11417 responder: ensure all providers record hit or miss
* SPD-11306 chat: more knowledge articles and various tweaks
* SPD-11406 RRPair markdown: handle mutable fields
* SPD-11419 dependency upgrades: basic
* SPD-11421 helm upgrade guards for nettap configmap
* SPD-11415 Build containers for trivy scan
* SPD-11408 Return a json response even on error
* SPD-11369 Add rpc for submitting test plan
* SPD-11406 RRPair markdown format: strip unnecessary data


## v2.5.344: 2026-03-17

* SPD-11306 chat: more backend tools
* SPD-11275 avoid any attempt to use smartdns when operating as nettap client
* SPD-11398 bugfix: handle larger bodies in proxymock inspect
* SPD-11369 Add CreateTestPlan rpc
* SPD-11348 move to golangci linter with custom lint rules
* SPD-11309 ensure closed flows are properly cleaned up
* SPD-11397 fix user management panic



## v2.5.337: 2026-03-13

* SPD-11329 add dummy package target for CLI tools
* SPD-11368 update nettap rbac to allow reading from its configmap
* SPD-11395 strip invalid build target
* SPD-11386 better signal handling for speedctl replay
* SPD-11382 Deprecate individual tuning tasks and make task definitions more descriptive
* SPD-11329 use smaller build images for services that can use them
* SPD-11390 bump default nettap version
* SPD-11387 Add timestampTime column
* SPD-11306 chat backend: move to a new lib for better context handling
* SPD-11370 mcp: improve all 6 proxymock MCP prompts
* SPD-11387 Add TimestampTime column to otel_logs
* SPD-11381 proxymock: clarify generate help text about OUT-direction RRPairs
* SPD-11377 proxymock: deduplicate error output on send-one failures
* SPD-11375 proxymock: improve context canceled/timeout error messages in replay
* SPD-11368 add nettap configmap env var
* SPD-11376 proxymock: wrap generate errors with user-friendly messages
* SPD-11373 proxymock: return non-zero exit code for unknown commands
* SPD-11374 proxymock: print error when inspect runs without TTY
* SPD-11360 Create a unified tuning mode and try more combinations of recommendations while tuning
* SPD-11371 remove speculation
* SPD-11371 Add claude hook for regenerating protos
* SPD-11371 add PreToolUse hook to block direct .pb.go edits
* SPD-11361 optimize some api call paths to prevent errors
* SPD-11359 remove unnecessary log fields
* SPD-11355 Add application error detection to report summary
* SPD-11349 Only apply certain transform recommendations
* SPD-11354 add performance to AI report summary
* SPD-11348 refactoring: more protojsonx updates
* SPD-11189 export: add Gatling simulation format
...
* SPD-11348 refactor: preparing for new linter
* SPD-11346 Add specialized apply recommendations task
* SPD-11347 use default ndots configuration for hostname resolution
* SPD-11325-2 add report summary RPC


## v2.5.304: 2026-03-10

* SPD-11343 revert changes for openshift
* SPD-11340 Fix SPD-11309 regressions: restore nettap tag and security context values
* SPD-11323 update to go1.26
* SPD-11325 add report summary AI chatbot tool
* SPD-11120 Show redis bulkstring as plain string whenever possible
* SPD-11337 Add name and description for transform recommendations
* SPD-11331 cookie jar changes for Go 1.26
* SPD-11328 Fix location segment wildcard logic for multiple layers of wildcards
* SPD-11309 Make jks job use user 0
* SPD-11326 speedctl load settings properly before overwrite
* SPD-11309 correct helm installation on openshift
* SPD-11312 Expose gateway RPCs as AI chat tools (Tier 1 + Tier 2)
* SPD-11310 correctly handle inbound traffic on istio ambient mesh
* SPD-11308 Generate a single request id recommendation
* SPD-11305 correct nettap daemonset security context


## v2.5.289: 2026-03-07

* SPD-11156 Wait for snapshot to finish reanalyzing before marking comparision task as done
* SPD-10793 better autogen-transforms command for tuning workflow
* SPD-11302 Add linguist-generated attr for proxymock RRPair files
* SPD-11291 Add teardown command to sos
* SPD-11156 Save transforms found from replay as recommendations
* SPD-11290 Bump java demo app version


## v2.5.283: 2026-03-04

* SPD-11279 preserve original host on service
* SPD-11241 lib/loader: migrate from deprecated s3/manager to s3/transfermanager
* SPD-11281 add Traffic Viewer tool to chat interface
* SPD-11274 prevent operator from removing nettap config modifications
* SPD-11278-2 add snapshot performance rpc:
* SPD-11278 add throughput and performance graphs to snapshot
* SPD-11262 add tolerations for arm64 nodes since images support them
* SPD-11257 read and republish logs from nettap capture
* SPD-11227 Add TrafficRecommendation for unreplaced REDACTED tokens
* SPD-11243 remove potential write blocks on received data chunks
* SPD-11246 chat: list test configs tool
* SPD-11246 api-gateway: support reasoning level for chat


## v2.5.271: 2026-02-27

* SPD-11251 api-gateway: add chat backend tools for snapshot and cluster operations
* SPD-11245 api-gateway: change default chat LLM model to gpt-5.2
* SPD-11241 fix ResourceExhausted on large report retrieval
* SPD-11240 address chat feedback - add specs
* SPD-11168 allow retrieval of workload capture status
* SPD-11168 allow for ebpf and java-agent capture configuration via API call
* SPD-11236 slim agents context
* SPD-11233 build: remove unused SpeedscaleUID const
* SPD-11238 simplify LLM env vars
* SPD-11234 include nettap installation status in operator check
* SPD-11235 add iptables exclusion for istio ambient mesh marked packets
* SPD-11210 chat support
* SPD-11204 set internal traffic policy for nettap svc
* SPD-11224 detect memory growth in traffic recommendations
* SPD-11223 add report recommendaations for K8s errors
* SPD-11205 refresh command/location for older rrpair captures
* SPD-11207 record durations for redis rrpairs


## v2.5.254: 2026-02-23

* SPD-11220 Use overall analyzer context for uploading final report
* SPD-11218 Ensure snapshot never has 0 duration
* SPD-11201 simplify replay coredns to sidecar pattern vs external svc
* SPD-11186 handle invalid status code for download
* SPD-11203 Delete assertion streamer
* SPD-11200 include any custom dns configuration setup for replay


## v2.5.248: 2026-02-19

* SPD-11193 Don't deploy collector when we only have custom uris
* SPD-11185 docs: fix AGENTS.md header after rename
* SPD-11185 refactor: rename CLAUDE.md to AGENTS.md with redirect
* SPD-11162 Handle getting pods for argo rollout with workloadRef
* SPD-11177 add hostname and duration to mongodb responses
* SPD-11171 Do not use readiness timeout as collector timeout
* SPD-11170 Move RRPair limit validation to api-gateway
* SPD-11151 sos: fix ebpf config index
* SPD-9186 Improve TLS error messages and notifications
* SPD-11152 goproxy internals refactor with less tight coupling
* SPD-11151 Add eBPF configuration support to sos validate command
* SPD-11165 Check for grpc cancelled error


## v2.5.236: 2026-02-17

* SPD-11158 Strip port from hosts before adding to service map
* SPD-11158 Use transformed hostnames for service map
* SPD-11157 Handle isTLS not being set properly
* SPD-11114 Remove search analyzer job
* SPD-1666 kube: Remove unused goproxy command port
* SPD-11114 Add full text and body search to MCP
* SPD-11150 remove speedbot
* SPD-11114 Add new text filter type
* SPD-11106 Make create user command accept a tenant name or id
* SPD-11136 handle coredns cleanup for cancelled replays
* SPD-11147 Replace numeric fields that are 0 in transforms
* SPD-11146 control ebpf port filters via annotation
* SPD-11142 support ebpf capture via annotation
* SPD-11113 Externalize DLP redactor and transforms initialization


## v2.5.222: 2026-02-12

* SPD-11121 move investigate agent commands to the proxymock MCP
* SPD-11136 mongodb sasl auth fallback: try to find first matching username
* SPD-10964 Remove notebook related db tables
* SPD-11131 Use referenced workload directly in argo rollouts with workloadRef
* SPD-11131 Include workload type when caching
* SPD-11111 handle invalid RRPairs offsets


## v2.5.216: 2026-02-10

* SPD-10964 Deprecate notebooks feature
* SPD-11112 Set custom uri in replay CR
* SPD-11133 add make-admin command to speedmgmt
* SPD-11125 Handle unicode nulls in json better
* SPD-11125 Temporarily skip bodies with null characters
* SPD-11129 hotfix for token flood
* SPD-11126 fix excessive data token discovery
* SPD-11125 Replace utf null rune instead of byte sequence
* SPD-111124 fix missing location in unrecognized tokens
* SPD-11094 updated nettap version
* SPD-10962 Fix header not eq case for filters
* SPD-11085 Detect MongoDB SASL authentication and generate transform recommendations
* SPD-11081 ensure all transform chains have proper tags for traceability
* SPD-11090 add recommendation for gRPC timestamp
* SPD-10962 Handle unicode null characters in jsonb column for rrpair data
* SPD-11102 save speedctl command line in speedctlCmdline report tag
* SPD-11096 Add new RPC for cluster sidecar stats


## v2.5.199: 2026-02-04

* SPD-10273 operator fixes for java-agent instrumentation
* SPD-11092 firehose: ensure all events are sent on shutdown
* SPD-110912 use dependency injection for AWS creds rather than mutating the gloabl environment
* SPD-11078 operator: more resilient workload collection
* SPD-11064 Add RedactSnapshot RPC to create DLP-redacted snapshots
* SPD-11083 snapshot analyzer: limit number of RRPairs in a single snapshot
* SPD-11068 autogenerated transforms: support query params and headers
* SPD-10961 Add advanced filter support for rrpairs
* SPD-10961 Add indexing of bodies and headers
* SPD-10273 mark proto field as optional
* SPD-10273 add annotation to inject nettap java agent
* SPD-11073 tune investigate-report command
* SPD-10960 Add column for rrpair bodies, headers, etc.
* SPD-11072 fix filter string quote escape issues
* SPD-10990 Fix indentation for security contexts and jks job permissions
* SPD-11053 tweak investigate report command
* SPD-11070 de-tune context err log


## v2.5.182: 2026-01-28

* SPD-11041 support mongodb sasl+scram auth in responder via replay transform
* SPD-11067 rename speedmgmt cmd package to cli
* SPD-11065 Only suggest transforms for request bodies
* SPD-10990 Better openshift support
* SPD-11062 Kafka output for proxymock
* SPD-11051 Remove references to custom patch and make inspector sidecar injection idempotent


## v2.5.176: 2026-01-23

* SPD-11059 Handle panic in snapshot update
* SPD-10932 mock tuning: check for responses before running
* SPD-11038 Move large lists from snapshot summary  analysis into separate data structures
* SPD-11053 slash command for investigating a snapshot
* SPD-11052 collector: retry on failure to collect metrics


## v2.5.171: 2026-01-22

* SPD-10971 Handle case in schema builder where primitive field is later an object
* SPD-11053 investigate-report command
* SPD-11050 do not create recommendations to IGNORE timestamps for responses of OUT RRPairs
* Fix proxymock generate to include BasePath in generated URLs
* SPD-10971 Add rpc for retrieving json schemas for snapshot
* SPD-10971 Fix early return for json schema generation
* SPD-10971 Add json schema artifact to snapshots
* SPD-10993 Use json schema builder in recommendation engine
* SPD-11050 fix panic: use correct proto package
* SPD-11047 Add FilterRRPairPredicates RPC to filter predicates against RRPairs
* SPD-11037 allow report status updates between final states
* SPD-11044 Handle expired ctx errors in event query loop


## v2.5.160: 2026-01-20

* SPD-11043 Only start analyzer job on replay start
* SPD-11042 Revert generator dlp config proto change
* SPD-10983 speedctl: pull all artifacts
* SPD-11039 add extensible transform recommendations
* SPD-11032 Add RegenerateFromRedacted function and dlp_field reverse support
* SPD-11003 speedctl infra dlp: clarify command
* SPD-11001 DLP transform recommendations: deduplicate, group, and sort
* SPD-11024 recognize data pattern in forwarder redaction
* SPD-11023 add DLP recommendation type
* SPD-11022 summarize dlp rules in snapshot
* SPD-11020 Add DLP recommendations to replace redacted values during replay
* SPD-11019 consolidate dlp recommendations
* SPD-11018 add DLP recommendation category
* SPD-11017 recommend DLP field for token redaction
* SPD-11016 wrap report retrieval in analyzer with smaller timeout window
* SPD-11010 attempt to recover from completed replays missing start event
* SPD-10987 responder: proper DLP implementation
* SPD-10997 Allow setting resource block and ephemeral storage for all components
* SPD-11009 extract tokens from responses
* SPD-10989 add TXT replicaSet overrides for mongo+srv support
* SPD-11000 Add tenant deletion command
* SPD-10998 Prevent custom DNS configs from being overwritten
* SPD-10971 Add json schema builder package
* SPD-10982 fix panic when comparing payloads: when keys differ during schema-only comparison
* SPD-10988 add AI prompt suggestion to fix discovered traffic issues
* SPD-10984 make TransformRecommendations ID human readable
* SPD-10969 Add report recommendations feature
* SPD-10978 CLAUDE.md: coding style
* SPD-10958 Remove signup via cli option
* SPD-10955 inspector log improvements
* SPD-10956 Handle report analyzer case where no done signal is seen
* SPD-10967 better handle errors when waiting for reports
* SPD-10966 reassign logger in responder
* SPD-10942 speedctl infra replay: service flag language
* SPD-10953 proxymock mcp install: guard against JSON mangling
* SPD-10940 proxymock mcp install: do not include type for Gemini
* SPD-10945 Set metric collection interval to 1s for replays
* SPD-10948 make recommendation IDs consistent across snapshot re-analysis
* SPD-10943 Add optional ID fields to TransformChain and TransformRecommendation
* SPD-10943 Filter transform chains to only active chains for DLP filtering


## v2.5.120: 2026-01-08

* SPD-10936 speedctl infra replay: rework address targeting behavior


## v2.5.119: 2026-01-08

* SPD-10878 Add support for changing kid in jwt transforms
* SPD-10929 Make calcDLPLocations return TransformRecommendations
* Add DLP token detection and transform recommendations


## v2.5.116: 2026-01-06

* SPD-10919: Add feature gate for speedscale-collector-persistent workload
* SPD-10885 generator support for kafka
* SPD-10855 check for mongo cluster information in additional response locations
* SPD-10917 Prevent nil transform chains when inactive
* SPD-10877 Add setting for limiting secret related access
* SPD-10914 Prevent error logs on expired notebooks
* SPD-10877 Don't generate a dynamic redis secret
