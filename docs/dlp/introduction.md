...
1. **Set Up Speedscale**: Install Speedscale's eBPF collector to capture traffic (see [Installation Guide](../quick-start.md) and [CLI Installation](../setup/install/cli.md))
...
- [Creating Snapshots](../guides/creating-a-snapshot.md) - Learn about creating and managing snapshots
