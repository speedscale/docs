...
2. [You have your Speedscale API Key](../../../getting-started/quick-start.md#retrieve-your-api-key)
...
The environment variables depend on the language of your app so refer to [proxy server configuration](/getting-started/installation/sidecar/proxy-modes.md#configuring-your-application-proxy-server)
and [trusting TLS certificates](/getting-started/installation/sidecar/tls.md#trusting-tls-certificates).
