...
value of a variable (if known) wherever it is found in the transform configuration:
...
random strings, files, [user data](../../reference/glossary.md#user-data), dataframe lookups, and
secrets. See [Embedded Syntax](./embedded-syntax.md) for the complete reference.
