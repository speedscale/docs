  ...
  docs: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          label: "Upgrade",
          items: [
            { type: "autogenerated", dirName: "getting-started/upgrade" },
          ],
          collapsed: true,
        },
      ],
        ...
        },
        {
          ...
          items: [
            { type: "autogenerated", dirName: "guides/message-brokers" },
            {
              type: "category",
              label: "GraphQL",
              link: { type: "doc", id: "guides/graphql/index" },
              items: [
                "guides/graphql/semantic-paths",
                "guides/graphql/editing",
                "guides/graphql/recipes",
              ],
              collapsed: true,
            },
            "guides/end-to-end",
